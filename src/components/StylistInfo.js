        ...
        <View style={[styles.card, isActive ? { width: '67%', height: hp('65%') } : { marginRight: hp('4.5%') }]}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', }}>
                ...
                <View style={styles.ratingView}>
                    ...
                    <Text style={{ color: colors.white, marginTop: hp('0.4%') }}>4.5 rating</Text>
                </View>
            </View>
            {isActive &&
                <View style={styles.textView}>
                    <Text style={styles.heading}>About Omnis iste</Text>
                    <Text style={{ color: colors.white, marginTop: hp('2%') }}>Sed ut perspiciatis unde omnis iste natus error sit{'\n'} voluptatem accusantium doloremque laudantium, totam{'\n'} rem aperiam, eaque ipsa quae ab illo inventore veritatis{'\n'} et quasi architecto beatae vitae dicta sunt explicabo.</Text>
